...
export const createVehicleBrand = async (c: Context) => {
    try {
        ...
        return c.json({ success: false, message: 'Error creating vehicle brand' }, 500);
    }
}
...
export const getVehicleBrandById = async (c: Context) => {
    try {
        ...
        const brandId = parseInt(c.req.param('id'));
        ...
        return c.json({ success: false, message: 'Error finding vehicle brand' }, 500);
    }
}
...
export const updateVehicleBrand = async (c: Context) => {
    try {
        ...
        return c.json({ success: false, message: 'Error updating vehicle brand' }, 500);
    }
}
...
export const deleteVehicleBrand = async (c: Context) => {
    try {
        ...
        return c.json({ success: false, message: 'Error deleting vehicle brand' }, 500);
    }
}